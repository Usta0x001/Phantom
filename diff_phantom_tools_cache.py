diff --git a/phantom/tools/cache.py b/phantom/tools/cache.py
deleted file mode 100644
index ad4ab5e..0000000
--- a/phantom/tools/cache.py
+++ /dev/null
@@ -1,423 +0,0 @@
...
-        
-        logger.info(
-            "Γ£à Cache HIT: %s (age=%.1fs, total_hits=%d, saved_ms=%.0f)",
