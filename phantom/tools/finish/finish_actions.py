...
def finish_scan(
    ...
    # AUTO-001 gates removed — scan completes when agent decides.
    # The gates were causing premature scan termination by blocking completion
    # even after real vulnerabilities were found. No iteration/tool requirements.
