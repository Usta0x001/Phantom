...
_TOOL_CATEGORIES: dict[str, ToolCategory] = {
    ...
    "add_hypothesis": ToolCategory.WRITE,
    "record_payload_test": ToolCategory.WRITE,
    "confirm_hypothesis": ToolCategory.WRITE,
    "reject_hypothesis": ToolCategory.WRITE,
    "query_hypotheses": ToolCategory.READ,
    "get_hypothesis_summary": ToolCategory.READ,
    "has_tested_payload": ToolCategory.READ,
    "create_agent": ToolCategory.OFFENSIVE,
    "wait_for_message": ToolCategory.READ,
    "view_agent_graph": ToolCategory.READ,
    "send_message_to_agent": ToolCategory.WRITE,
    "agent_finish": ToolCategory.OFFENSIVE,
    "set_scan_status_context": ToolCategory.WRITE,
    ...
    "python_action": ToolCategory.WRITE,
    ...
    "agent_finish": ToolCategory.OFFENSIVE,
    "check_scan_registry": ToolCategory.READ,
    "register_scan_target": ToolCategory.WRITE,
    "wait_for_agents": ToolCategory.READ,
    "get_scan_status": ToolCategory.READ,
    "get_hypothesis_summary": ToolCategory.READ,
    "query_hypotheses": ToolCategory.READ,
    "has_tested_payload": ToolCategory.READ,
