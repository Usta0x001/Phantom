...
hiddenimports = [
    ...
    'phantom',
    'phantom.interface',
    'phantom.interface.main',
    'phantom.interface.cli',
    'phantom.interface.tui',
    'phantom.interface.utils',
    'phantom.interface.tool_components',
    'phantom.agents',
    'phantom.agents.base_agent',
    'phantom.agents.state',
    'phantom.agents.PhantomAgent',
    'phantom.llm',
    'phantom.llm.llm',
    'phantom.llm.config',
    'phantom.llm.utils',
    'phantom.llm.memory_compressor',
    'phantom.runtime',
