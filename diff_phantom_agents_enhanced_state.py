diff --git a/phantom/agents/enhanced_state.py b/phantom/agents/enhanced_state.py
deleted file mode 100644
index e1a628e..0000000
--- a/phantom/agents/enhanced_state.py
+++ /dev/null
@@ -1,594 +0,0 @@
-"""
...
-            return True  # cap reached ΓÇö treat as "already tested" so agent skips it
...
-                # Skip known false positives ΓÇö don't clutter results
...
-                return
-        except Exception:
-            pass  # Knowledge store unavailable ΓÇö continue normally
-        
...
-            data["tools_used"] = {}
-
-        # Size guards ΓÇô refuse absurdly large payloads
-        MAX_LIST_LEN = 50_000
-        MAX_DICT_LEN = 10_000
