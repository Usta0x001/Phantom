...
Skip the setup. Run phantom in the cloud at [app.phantom.ai](https://app.phantom.ai).
...
1. Sign up at [app.phantom.ai](https://app.phantom.ai)
2. Connect your repository or enter a target URL
3. Launch your first scan

<Card title="Try phantom Cloud" icon="rocket" href="https://app.phantom.ai">
