...
description: "Configure phantom with Gemini models via Google Cloud"
---

## Installation

Vertex AI requires the Google Cloud dependency. Install phantom with the vertex extra:

```bash
pipx install "phantom-agent[vertex]"
```

## Setup

```bash
export phantom_LLM="vertex_ai/gemini-3-pro-preview"
```
