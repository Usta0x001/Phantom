---
title: "Azure OpenAI"
description: "Configure phantom with OpenAI models via Azure"
---

## Setup

```bash
export phantom_LLM="azure/your-gpt5-deployment"
...
|----------|-------------|
| `phantom_LLM` | `azure/<your-deployment-name>` |
...
```bash
export phantom_LLM="azure/gpt-5-deployment"
