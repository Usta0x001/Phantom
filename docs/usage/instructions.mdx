...
description: "Guide phantom with custom testing instructions"
---
...
```bash
phantom --target https://app.com --instruction "Focus on authentication vulnerabilities"
```
...
```bash
phantom --target https://app.com --instruction-file ./pentest-instructions.md
```
...
```bash
phantom --target https://api.example.com \
...
<Tip>
Be specific. Good instructions help phantom prioritize the most valuable attack paths.
</Tip>
