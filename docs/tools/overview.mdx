---
title: "Agent Tools"
description: "How phantom agents interact with targets"
---

phantom agents use specialized tools to test your applications like a real penetration tester would.
