---
title: "Sandbox Tools"
description: "Pre-installed security tools in the phantom container"
---

phantom runs inside a Kali Linux-based Docker container with a comprehensive set of security tools pre-installed. The agent can use any of these tools through the [terminal](/tools/terminal).
