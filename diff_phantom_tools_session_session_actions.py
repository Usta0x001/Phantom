diff --git a/phantom/tools/session/session_actions.py b/phantom/tools/session/session_actions.py
index 7955a07..0ccfdaa 100644
--- a/phantom/tools/session/session_actions.py
+++ b/phantom/tools/session/session_actions.py
@@ -82,173 +82,7 @@ def clear_sessions() -> None:
...
-    ``{"found": False}`` if it has not been stored yet ΓÇö in which case you
