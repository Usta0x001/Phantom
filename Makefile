...
lint:
	...
	poetry run pylint phantom/ --score=no --reports=no
	@echo "✅ Linting complete!"

type-check:
	@echo "🔍 Type checking with mypy..."
	poetry run mypy phantom/
	@echo "🔍 Type checking with pyright..."
	poetry run pyright phantom/
	@echo "✅ Type checking complete!"

security:
	@echo "🔒 Running security checks with bandit..."
	poetry run bandit -r phantom/ -c pyproject.toml
...
test-cov:
	...
	poetry run pytest -v --cov=phantom --cov-report=term-missing --cov-report=html
